...
class CollapsibleSection(QFrame):
    """A titled section whose body folds away, with an animated height."""
    ...
    def __init__(
        ...
        *,
        ...
        header_layout.addWidget(self.summary_label, 0, Qt.AlignmentFlag.AlignRight)
        ...
        self._animator = HeightAnimator(self.body)
    ...
    def animation(self) -> QPropertyAnimation:
        return self._animator.animation()
    ...
    def set_expanded(self, expanded: bool, *, animate: bool = True) -> None:
        ...
        if not animate:
            self.body.setMaximumHeight(UNLIMITED_HEIGHT if expanded else 0)
            self.body.setVisible(expanded)
            return
        if expanded:
            self._animator.expand()
        else:
            self._animator.collapse()
